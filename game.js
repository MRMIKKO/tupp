...
class Game {
    ...
    update() {
        ...
        if (this.difficultyTimer >= this.difficultyIncreaseInterval && this.difficulty < this.maxDifficulty) {
            this.difficulty++;
            this.difficultyTimer = 0;
            
            // 显示难度提升提示（可选）
            console.log(`难度提升到 ${this.difficulty}！`);
        }
        ...
        // 难度越高，可能同时生成多架敌机
        const simultaneousSpawns = Math.min(3, Math.floor(this.difficulty / 3) + 1);
